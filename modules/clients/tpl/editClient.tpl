		...
		<div class="BronBlockInfo">
			<div class="ClientObjects">		
				...
				<table class="ObjectsList" width="100%">
					...
					<tr>
						<td class="idcol"><a class="id_l" href="/admin/realties/newRealty/<?=$order->id?>"><?=$order->id?></a></td>
								<td class="tg-vn4c"><a class="name_l" href="/admin/realties/newRealty/<?=$order->id?>"><?=$order->name?$order->name:'Не указано'?></a><br>
						...
						<td class="tg-vn4c"><?=$order->date?></td>
