<div class="main_edit">
	...
	<div class="orderHeader">
		...
		<div class="modules">
			<div><img src="/modules/orders/images/icons/domain_<?=$order->domain?>_logo.png"/></div>
		</div>
	</div>
			<table width="100%">
				<tr>
							...
							<tr>
								<td>
									...
									<p class="additionalData">
										...
										тел. <strong><input
											type="text"
											class="transformer contactsEdit editOrderInputs hide"
									...
									<div class="additionalData">
										...
										<input
											...
											data-action="/admin/orders/editOrder/?orderId=<?=$order->id?>"
											data-default="<?=$this->checkUserRight('order_edit_from_view_mode')?'указать дату':'не указана'?>"
										/>
										</strong>
										<strong>
										<input
											...
											data-action="/admin/orders/editOrder/?orderId=<?=$order->id?>"
											data-default="<?=$this->checkUserRight('order_edit_from_view_mode')?'указать время':'не указано'?>"
										/>
										</strong>
										<br/>
										Контактное лицо:
										...
										<ul class="additionalData">
											...
											<li>
												...
												<select
													class="editOrderSelects transformer hide"
													data-action="/admin/orders/editOrder/?orderId=<?=$order->id?>"
													name="partnerNotified"
												>
													<option value="1" <?=( $order->partnerNotified )?'selected=true':''?>> принял</option>
													<option value="0" <?=( $order->partnerNotified )?'':'selected=true'?>> не принял</option>
												</select>
											</li>
											<li>
												Процент
