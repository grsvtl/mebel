<tr>
	...
	<td style="border-bottom: 1px dotted #007fb9;">
		<a href="http://<?= $_SERVER['HTTP_HOST']?><?=$good->getGood()->getPath()?>" target="_blank">
			...
			<? else: ?>
			<img border="0" src="http://<?= $_SERVER['HTTP_HOST']?><?=$good->getGood()->getFirstPrimaryImage()->getImage('50x50')?>" height="50" width="50">
			<? endif; ?>
		</a>
	</td>
	<td align="left" style="padding-left: 20px; border-bottom: 1px dotted #007fb9;">
		<a href="http://<?= $_SERVER['HTTP_HOST']?><?=$good->getGood()->getPath()?>" target="_blank"><?=$good->getGood()->getName()?> (<?=$good->getGood()->getCode()?>)</a>
		<br />
