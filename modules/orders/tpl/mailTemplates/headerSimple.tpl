		...
		<table border="0" cellpadding="0" cellspacing="0" style="border-left: 5px solid #24667B; width: 900px;">
			<tr>
				<td style="padding: 0px 0px 0px 10px; width: 60px;">
					...
					<img border="0" src="<?=$this->setImageHere(DIR.'/images/bg/'.$this->getCurrentDomainAlias().'_logo.png')?>" width="50">
					<? else: ?>
					<img border="0" src="<?=DIR_HTTP?>/images/bg/<?=$this->getCurrentDomainAlias()?>_logo.png" height="20" alt="">
					<? endif; ?>
				</td>
