								...
								<td colspan="3">
									<table>
										...
										<tr>
											...
											<td><input style="width: 20px" class="filterInput" type="checkbox" name="partnerNotified" value="1" <?= $this->getGET()['partnerNotified'] ? 'checked' : ''?> /></td>
										</tr>
										<tr>
							...
							<tr>
								...
								<td>
									<select class="groupActionSelect">
										...
										<option value="groupDriver">Таблица водителя</option>
										<?endif?>
