...
//				$('.editProperty', $(this).parents('.propertiesParts')).toggle();
				...
				$('.viewMode', $(this).parents('.propertiesParts')).hide();
				$('.editProperty', $(this).parents('.propertiesParts')).show();
...
//				$('.editProperty', $(this).parents('.propertiesParts')).toggle();
				...
				$('.viewMode', $(this).parents('.propertiesParts')).show();
				$('.editProperty', $(this).parents('.propertiesParts')).hide();
