<div class="menu">
	...
	<?endif?>
	<?if($this->checkUserRight('fabricators')):?>
		<a href="/admin/fabricators/" <?= $this->getREQUEST()['controller']=='clients' ? 'class="underline" ' : ''?>>Производители</a>
	<?endif?>
	...
	<?endif?>
	<?if($this->checkUserRight('parameters')):?>
		<a href="/admin/parameters/" <?= $this->getREQUEST()['controller']=='parameters' ? 'class="underline" ' : ''?>>Параметры</a>
	<?endif?>
	<?if($this->checkUserRight('properties')):?>
		<a href="/admin/properties/" <?= $this->getREQUEST()['controller']=='parameters' ? 'class="underline" ' : ''?>>Свойства</a>
	<?endif?>
