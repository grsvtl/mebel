...
//			->setContent('content', $this->getContent('myOrder'))
	...
	protected function isGoodsInShopcart($shopcart = null)
	{
	...
	{
		$this->setContent('shopcartCount', $this->getShopcartCount())
			->includeTemplate('shopcart/shopcartBar');
	}

	private function getShopcartCount()
    {
        return (int)$this->getShopcart()->getTotalQuantity();
    }

    protected function ajaxGetShopcartCount()
    {
        echo $this->getShopcartCount();
    }
	...
	protected function ajaxGetShopcartBarContent()
    {
        ob_start();
        $this->getShopcartBar();
