							...
							<?if($good->isAnComplect()):?>
								...
								<tr>
									<td>
										<div class="image">
											<a href="<?=$_SERVER['HTTP_HOST'].$good->getPrimaryGood()->getGood()->getPath()?>">
												<img src="http://<?= $_SERVER['HTTP_HOST'].$good->getPrimaryGood()->getGood()->getFirstPrimaryImage()->getFocusImage('100x0', 'watermark')?>" alt="" />
											</a>
										</div>
									</td>
									<td>
								...
								<?if($good->getSecondaryGoods()->count()):?>
									...
									<tr>
										<td>
											<div class="image">
												<img src="http://<?= $_SERVER['HTTP_HOST'].$complectSubgood->getGood()->getFirstPrimaryImage()->getFocusImage('100x0', 'watermark')?>" alt="" />
											</div>
										</td>
										<td>
											<p class="name">
									...
									<table>
										...
										<tr>
											<td style="text-align: left; margin-left: 20px;">
												<?=$i?>.
												<img src="<?=$_SERVER['HTTP_HOST'].$subGood->getGood()->getFirstPrimaryImage()->getUserImage('30x0', 'watermark')?>" alt="">
