	...
	<div class="textPageMain">
		<div class="textPage">
			<div class="bc">
				<a href="">Главная</a>
				<span>/</span>
				<span class="pageNameBC">Корзина</span>
			</div>
			<h1>Корзина</h1>
...
<!--                                                <h4>Форма заявки</h4>-->
                                    ...
                                    <br>
                                    <button type="button" class="btn btn-info btn-lg sendOrderGetSuccessBlock" data-dataLayerPushEvent="form_basket">
                                        Оформить заказ
                                    </button>
                                    <br>
                                    <br>
